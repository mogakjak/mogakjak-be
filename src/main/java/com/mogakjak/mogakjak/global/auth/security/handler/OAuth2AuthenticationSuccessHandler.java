...
import com.mogakjak.mogakjak.global.auth.service.TokenStorageService;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private String getEmailFromPrincipal(OAuth2User principal) {
        ...
        if (email == null) {
            throw new CustomException(AuthExceptionCode.EMAIL_NOT_PROVIDED);
        }
    ...
    private Object getProviderIdFromPrincipal(OAuth2User principal) {
        ...
        throw new CustomException(AuthExceptionCode.PROVIDER_ID_NOT_FOUND);
    }
    ...
    private ProviderType resolveProviderType(Authentication authentication, OAuth2User principal) {
        ...
        throw new CustomException(AuthExceptionCode.PROVIDER_TYPE_NOT_FOUND);
    }
